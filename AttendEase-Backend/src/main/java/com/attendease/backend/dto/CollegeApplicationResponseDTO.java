...
public class CollegeApplicationResponseDTO{
	...
	public CollegeApplicationResponseDTO(Long id,String collegeName,String authorityName,String authorityRole,String officialEmail,LocalDateTime createdAt) {
		this.id = id;
